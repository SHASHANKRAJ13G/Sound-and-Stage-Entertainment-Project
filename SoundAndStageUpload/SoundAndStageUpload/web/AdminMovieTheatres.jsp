...
<html>
    ...
    <body>
            ...
            String values[] = request.getParameterValues("halls");
            ...
            if( values != null )
            {
                ...
                if( errormsg.equals("") )
                {
                    ...
                    if( conn != null )
                    {
                        ...
                        {
                            /////////////
                            query = "select * from halls where hall_code=?";
                            ...
                            if( count == 0 )
                            {
                                query = "insert into halls (hall_code,hall_plan,site_name,snacks) values (?,?,?,?)";
                            ...
                            {
                                query = "update halls set hall_code = ? , hall_plan = ? , site_name = ? , snacks = ? where hall_code=?";
                        ...
                        {
                            query = "delete from halls where hall_code = ?";
            ...
            %>
                ...
                ">
                        ...
                        <form id="myForm" action="AdminMovieTheatres.jsp" method="post"style="
                position: absolute;
                top: 0px;
                left: 0px;
                width: 100%;
                ...
                ">
                            ...
                            <input type="text" name="halls" autofocus="true" placeholder="Enter Hall Code..." style="
                position: absolute;
                top: 45px;
                left: 165px;
                width: 25%;
                ...
                %>
                            ...
                            <input type="text" name="halls" autofocus="true" placeholder="Enter Hall Plan..." style="
                position: absolute;
                top: 45px;
                left: 765px;
                width: 25%;
                ...
                <select name="halls" autofocus="true" placeholder="Site Name..." style="
                position: absolute;
                top: 145px;
                left: 165px;
                width: 25%;
                ...
                <%
                    ...
                    if( conn != null )
                    {
                        String query = "select site_location from sites";
                ...
                <input type="hidden" name="halls" id="delete" value="false"/>
                
                <select name="halls" style="
                position: absolute;
                top: 145px;
                left: 765px;
                width: 25%;
                ...
                <%
                    ...
                    if( conn != null )
                    {
                        String query = "select snack_name from snacks";
                        ...
                        else
                        {
                            do
                            {
                                ...
                                {
                                    %>
                                    <option selected="true"><%=rs.getString(1)%></option>
                                    <%
                                }
                                else
                                {
                                    ...
                                    while( rs.next() )
                                    {
                                        ...
                                        %>
                                            <tr onclick="
                                                ...
                                                var str = '<%=rs.getString(5)%>';
                                                
                                                el = oFormObject.elements[4];
                                                for (var i = 0; i < el.length; i++)
                                                {
                                                    //alert(el[i].text);
                                                    if ( str.indexOf(el[i].text) != -1 )
                                                    {
                                                        el[i].selected = true;
                                                    }
                                                    else
