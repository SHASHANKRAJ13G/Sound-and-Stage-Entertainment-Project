...
<html>
    ...
    <body>
            ...
            String values[] = request.getParameterValues("sites");
                ...
                if( errormsg.equals("") )
                {
                    ...
                    if( conn != null )
                    {
                        ...
                        if( delete.equals("false") )
                        {
                            ...
                            if( count == 0 )
                            {
                                query = "insert into sites (site_name,site_location) values (?,?)";
                            ...
                            {
                                query = "update sites set site_name = ? , site_location = ? where site_name=?";
                        ...
                        {
                            query = "delete from sites where site_name = ?";
            ...
            %>
                ...
                ">
                        ...
                        <form id="myForm" action="AdminSites.jsp" method="post"style="
                position: absolute;
                top: 0px;
                left: 0px;
                width: 100%;
                ...
                ">
                            ...
                            <input type="text" name="sites" autofocus="true" placeholder="Enter Site Name..." style="
                position: absolute;
                top: 45px;
                left: 165px;
                width: 25%;
                ...
                %>
                            ...
                            <input type="text" name="sites" autofocus="true" placeholder="Enter Site Location..." style="
                position: absolute;
                top: 45px;
                left: 765px;
                width: 25%;
                ...
                <input type="hidden" name="sites" id="delete" value="false"/>
