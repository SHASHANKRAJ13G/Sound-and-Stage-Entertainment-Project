    ...
    <body>
            ...
            %>
                ...
                ">
                        ...
                        <form id="myForm" action="AdminMovies.jsp" method="post"style="
                position: absolute;
                top: 0px;
                left: 0px;
                width: 100%;
                ...
                ">
                            ...
                            <input type="text" name="movies" autofocus="true" placeholder="Enter Movie Name..." style="
                position: absolute;
                top: 45px;
                left: 165px;
                width: 25%;
                ...
                <input type="text" name="movies" autofocus="true" placeholder="Enter Movie Intro..." style="
                position: absolute;
                top: 45px;
                left: 765px;
                width: 25%;
                ...
                <input type="text" name="movies" autofocus="true" placeholder="Enter Genre..." style="
                position: absolute;
                top: 145px;
                left: 165px;
                width: 25%;
                ...
                <input type="text" name="movies" autofocus="true" placeholder="Enter Cast of Characters..." style="
                position: absolute;
                top: 145px;
                left: 765px;
                width: 25%;
                ...
                <input type="hidden" name="movies" id="delete" value="false"/>
